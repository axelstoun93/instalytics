<div class="collapse navbar-collapse" id="navbar-mobile">
    ...
    <ul class="nav navbar-nav float-right">
        ...
        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle dropdown-toggle-arrow nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="/{{$userInfo->account->avatar}}" alt="avatar"><i></i></span><span class="user-name">{{$userInfo->name}}</span></a>
