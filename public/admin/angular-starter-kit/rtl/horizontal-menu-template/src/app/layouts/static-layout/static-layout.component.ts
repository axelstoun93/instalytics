...
export class StaticLayoutComponent implements OnDestroy, OnInit  {
    ...
    constructor(private renderer: Renderer2, private elRef: ElementRef) {
     ...
     ngOnInit() {
      ...
      this.renderer.removeClass(elm, 'navbar-fixed');
      this.renderer.addClass(elm, 'navbar-static');
    ...
    ngOnDestroy() {
      ...
      const elm = this.elRef.nativeElement.querySelector('#stackMenu')
      this.renderer.addClass(elm, 'navbar-fixed');
      this.renderer.removeClass(elm, 'navbar-static');
    }
  }
