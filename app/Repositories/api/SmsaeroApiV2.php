...
class SmsaeroApiV2
{
    ...
    private $email = 'gearsxb1@mail.ru'; //Ваш логин|email
    private $api_key = '4M8ABQzXpDLvDOr1aFORRi0Chy5s'; //Ваш api_key можно получить по адресу https://smsaero.ru/cabinet/settings/apikey/
