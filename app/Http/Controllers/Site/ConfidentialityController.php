...
class ConfidentialityController extends SiteController
{
    /**
    ...
    {
        $this->title = 'Политика конфиденциальности | Честный сервис instagram статистики datalytics.pro';
